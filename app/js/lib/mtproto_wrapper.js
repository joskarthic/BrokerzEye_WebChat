...
.factory('MtpApiManager', function (Storage, MtpAuthorizer, MtpNetworkerFactory, MtpSingleInstanceService, ErrorService, qSync, $q, BrokerzeyeMeWebService) {
  ...
  function telegramMeNotify (newValue) {
    if (telegramMeNotified !== newValue) {
      ...
      BrokerzeyeMeWebService.setAuthorized(telegramMeNotified);
    }
  }
