...
.service('AppMessagesManager', function ($q, $rootScope, $location, $filter, ApiUpdatesManager, AppUsersManager, AppChatsManager, AppPeersManager, AppPhotosManager, AppVideoManager, AppDocsManager, AppAudioManager, MtpApiManager, MtpApiFileManager, RichTextProcessor, NotificationsManager, PeersSelectService, Storage, FileManager, BrokerzeyeMeWebService, StatusManager, _) {
  ...
  function getDialogs (query, maxID, limit) {
    ...
    return MtpApiManager.invokeApi('messages.getDialogs', {
      ...
      BrokerzeyeMeWebService.setAuthorized(true);
...
.service('BrokerzeyeMeWebService', function (Storage) {
...
.service('LocationParamsService', function ($rootScope, $routeParams, AppUsersManager) {
  ...
  function start () {
    ...
    started = true;
    try {
      navigator.registerProtocolHandler('tg', '#im?tgaddr=%s', 'Brokerzeye Web');
    } catch (e) {}
    try {
      navigator.registerProtocolHandler('web+tg', '#im?tgaddr=%s', 'Brokerzeye Web');
    } catch (e) {}
